...
//                .as(Encoders.BINARY());
//
//        Dataset<RealDataInfoEntity> BODS = bytesRow.map(new MapFunction<byte[], RealDataInfoEntity>() {
//
//            @Override
//            public RealDataInfoEntity call(byte[] value) throws Exception {
//                DataSerializer<RealDataInfoEntity> deserializer = DataSerializerFactory
//                        .createSerializer(EnumSerializerType.ProtobufRealData);
//                RealDataInfoEntity entity = deserializer.dataDeSerializer(value);
//                System.out.println("==================");
//                System.out.println(entity.getDeviceId());
//                return  entity;
//            }
//        }, Encoders.kryo(RealDataInfoEntity.class));
//
//        StreamingQuery query = BODS.writeStream()
//                .outputMode("update")
//                .format("console")
//                .option("checkpointLocation", "./test202")
